...
public class MecanumDriveTrain extends LinearOpMode {
    ...
    private final int POSITION_HIGH = 3850;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        ElapsedTime a_button = new ElapsedTime();
        ...
        while (opModeIsActive()) {
            ...
            // closed
            if(claw_state) {
                clawServo1.setPosition(0.10);
                clawServo2.setPosition(0.9);
            }
            // open
            else {
                clawServo1.setPosition(0.30);
                clawServo2.setPosition(0.65);
            }
            ...
            telemetry.addData("Left (Linear) Motor Position", LeftLinearSlide.getCurrentPosition());
            telemetry.addData("Right (Linear) Motor Position", RightLinearSlide.getCurrentPosition());
            telemetry.addData("ArmMotor Position", position);
            telemetry.update();
