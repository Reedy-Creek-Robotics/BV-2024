...
@Autonomous
public class MecanumAutoDriveTest extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        RobotMovement movement = new RobotMovement(LeftLinearSlide, RightLinearSlide, frontLeftMotor, backLeftMotor, frontRightMotor, backRightMotor, imu, this);
        ...
        movement.strafeLeft(16);
        movement.turn(47);
        movement.backward(58.06);
        specServo1.setPosition(0.5);
        specServo2.setPosition(0.5);
        sleep(500); // Can be 200
        LeftLinearSlide.setTargetPosition(POSITION_SPECIMEN_HIGH);
        RightLinearSlide.setTargetPosition(-POSITION_SPECIMEN_HIGH);
        sleep(500);
        // Vivaan le Buffalo did something chat
        movement.strafeLeft(52.5);
        movement.turn(46);
        movement.backward(18.45);
        LeftLinearSlide.setTargetPosition(POSITION_SPECIMEN_LOW);
        RightLinearSlide.setTargetPosition(-POSITION_SPECIMEN_LOW);
        sleep(600); // Can be 200
        specServo1.setPosition(0);
        specServo2.setPosition(1);
        movement.forward(11.4);
        ...
        movement.turn(48.5);
        movement.backward(17); // Abhinav's quad Edit
        LeftLinearSlide.setTargetPosition(POSITION_SPECIMEN_LOW);
        RightLinearSlide.setTargetPosition(-POSITION_SPECIMEN_LOW);
